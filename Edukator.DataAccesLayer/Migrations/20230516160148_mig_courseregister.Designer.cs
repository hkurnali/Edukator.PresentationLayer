...
namespace Edukator.DataAccesLayer.Migrations
{
    ...
    [Migration("20230516160148_mig_courseregister")]
    partial class mig_courseregister
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edukator.EntityLayer.Concrete.AboutPageCourse", b =>
                {
                    b.Property<int>("AboutPageCourseID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("AboutPageCourseID");

                    b.ToTable("AboutPageCourses");
                });

            modelBuilder.Entity("Edukator.EntityLayer.Concrete.AboutPageEntrance", b =>
                {
                    b.Property<int>("AboutPageEntranceID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Edukator.EntityLayer.Concrete.ContactPageMessage", b =>
                {
                    b.Property<int>("ContactPageMessageID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ContactPageMessageID");

                    b.ToTable("ContactPageMessages");
                });
            ...
            modelBuilder.Entity("Edukator.EntityLayer.Concrete.Footer", b =>
                {
            ...
            modelBuilder.Entity("Edukator.EntityLayer.Concrete.CourseRegister", b =>
                {
                    b.HasOne("Edukator.EntityLayer.Concrete.AddUser", "AddUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Edukator.EntityLayer.Concrete.AddUser", null)
                        .WithMany()
